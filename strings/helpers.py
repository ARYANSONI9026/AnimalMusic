...
**⌯ ᴛσ ϻᴧᴋє ʏσυꝛ ʙσᴛ, ʏσυ sʜσυʟᴅ ғσʟʟσᴡ ᴛʜєsє sᴛєᴘs

⌯ 1➤ σᴘєη @BotFather ᴧηᴅ ᴄꝛєᴧᴛє ᴧ ηєᴡ ʙσᴛ.

⌯ 2➤ ʏσυ’ʟʟ ɢєᴛ ᴧ ᴛσᴋєη (є.ɢ. 12345:6789ᴧʙᴄᴅЄҒ) 

⌯ 3➤ ᴧғᴛєꝛ /clone ᴄσϻϻᴧηᴅ

⌯ єɢ. /clone 12345:6789ᴧʙᴄᴅЄҒ **
"""
...
CHELP_1 = """**
❖ ᴄʟᴏɴᴇʀ ᴄᴏᴍᴍᴀɴᴅs ғᴏʀ ᴍᴜsɪᴄ❖

❍ /clone ➠ ᴄʟᴏɴᴇ ʏᴏᴜʀ ᴍᴜsɪᴄ ʙᴏᴛ  
❍ /delclone | /delbot | /rmbot | /delcloned | /deleteclone | /removeclone | /cancelclone ➠ ᴅᴇʟᴇᴛᴇ ᴄʟᴏɴᴇᴅ ʙᴏᴛ  
❍ /cloned ➠ ʟɪsᴛ ᴀʟʟ ᴄʟᴏɴᴇᴅ ʙᴏᴛs  
❍ /clonedinfo ➠ ᴠɪᴇᴡ ᴅᴇᴛᴀɪʟs ᴏғ ᴀʟʟ ᴄʟᴏɴᴇᴅ ʙᴏᴛs  
❍ /mybot | /mybots ➠ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴘᴇʀsᴏɴᴀʟ ᴄʟᴏɴᴇᴅ ʙᴏᴛs  

❖ ᴄʟᴏɴᴇʀ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ❖

❍ /addcloner ➠ ᴀᴅᴅ ᴀ ᴜsᴇʀ ᴛᴏ ᴄʟᴏɴᴇʀ ʟɪsᴛ  
❍ /delcloner | /removecloner ➠ ʀᴇᴍᴏᴠᴇ ᴀ ᴜsᴇʀ ғʀᴏᴍ ᴄʟᴏɴᴇʀ ʟɪsᴛ  
❍ /cloners | /listcloner | /cloner | /clonerlist ➠ ᴠɪᴇᴡ ʟɪsᴛ ᴏғ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴄʟᴏɴᴇʀs  

━━━━━━━━━━━━━━━━━━━━━━━  
🚨 **ᴏᴡɴᴇʀ-ᴏɴʟʏ ᴄᴏᴍᴍᴀɴᴅs** 🚨  

❍ /delallclone ➠ **ᴅᴇʟᴇᴛᴇ ᴀʟʟ ᴄʟᴏɴᴇᴅ ʙᴏᴛs** (ᴏɴʟʏ ᴏᴡɴᴇʀ ᴄᴀɴ ᴘᴇʀғᴏʀᴍ ᴛʜɪs ᴀᴄᴛɪᴏɴ)  
❍ /restartclones ➠ **ʀᴇsᴛᴀʀᴛ ᴀʟʟ ᴄʟᴏɴᴇᴅ ʙᴏᴛs** (ᴏᴡɴᴇʀ ᴏɴʟʏ)  

ɴᴏᴛɪᴄᴇ :-  
🔹 ᴏɴʟʏ ᴛʜᴇ **ᴏᴡɴᴇʀ** ᴄᴀɴ ᴅᴇʟᴇᴛᴇ ᴀʟʟ ᴄʟᴏɴᴇᴅ ʙᴏᴛs ᴏʀ ʀᴇsᴛᴀʀᴛ ᴛʜᴇᴍ.  
🔹 ᴛʜɪs ғᴇᴀᴛᴜʀᴇ ᴏɴʟʏ ᴄʟᴏɴᴇs ᴛʜᴇ **ᴍᴜsɪᴄ ʙᴏᴛ**, ɴᴏᴛ ᴀʟʟ ғᴇᴀᴛᴜʀᴇs.  
**"""

CHELP_2 = """**
❖ ᴜsᴇʀʙᴏᴛ ᴄʟᴏɴᴇʀ ᴄᴏᴍᴍᴀɴᴅs ❖

❍ /ustart ➠ ᴏᴘᴇɴ ᴛʜᴇ sᴛᴀʀᴛ ᴍᴇɴᴜ ғᴏʀ ᴜsᴇʀʙᴏᴛ ᴄʟᴏɴᴇʀ  
❍ /uclone ➠ ᴄʟᴏɴᴇ ʏᴏᴜʀ ᴜsᴇʀʙᴏᴛ ᴀᴄᴄᴏᴜɴᴛ  
❍ .helpme ➠ ᴠɪᴇᴡ ᴀʟʟ ᴜsᴇʀʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅs  

━━━━━━━━━━━━━━━━━━━━━━━  
🔹 **ɪᴍᴘᴏʀᴛᴀɴᴛ ɴᴏᴛᴇs:**  
✔️ ᴛᴏ ᴄʟᴏɴᴇ ᴀ **ᴜsᴇʀʙᴏᴛ**, ʏᴏᴜ ᴍᴜsᴛ ɢᴇɴᴇʀᴀᴛᴇ ᴀ **sᴛʀɪɴɢ sᴇssɪᴏɴ**.  
✔️ ʏᴏᴜ ᴄᴀɴ ɢᴇɴᴇʀᴀᴛᴇ ɪᴛ ʙʏ ᴜsɪɴɢ **[@Strinng_Session_Bot](https://t.me/Strinng_Session_Bot)**.  
✔️ ᴛʜɪs ғᴇᴀᴛᴜʀᴇ **ᴏɴʟʏ ᴄʟᴏɴᴇs ᴜsᴇʀʙᴏᴛs**, ɴᴏᴛ ᴀʟʟ ғᴇᴀᴛᴜʀᴇs.  
