    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("tabahi_tabahi")
                await self.one.join_chat("knight_society")
                await self.one.join_chat("tabahi_tabahi")
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("tabahi_tabahi")
                await self.two.join_chat("knight_society")
                await self.two.join_chat("tabahi_tabahi")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("tabahi_tabahi")
                await self.three.join_chat("knight_society")
                await self.three.join_chat("tabahi_tabahi")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("tabahi_tabahi")
                await self.four.join_chat("knight_society")
                await self.four.join_chat("tabahi_tabahi")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("tabahi_tabahi")
                await self.five.join_chat("knight_society")
                await self.five.join_chat("tabahi_tabahi")
            except:
                pass
